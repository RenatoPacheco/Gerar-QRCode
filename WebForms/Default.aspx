...
<html lang="pt-br">
  <head>
    ...
    <link href="<%=ResolveUrl("~/Scripts/gerarqrcode/gerarQRCode.min.css")%>" rel="stylesheet">
  ...
  <body>
    ...
    <!--
    <h2 class="text-center">Gerador de QRCode #2</h2>
    <div class="container" id="ex2"></div>
    <h2 class="text-center">Gerador de QRCode #3</h2>
    <div class="container" id="ex3"></div>
    -->
    <!--
    <p class="glyphicon glyphicon-list-alt text-center" style="font-size:25em;padding:10px;"></p>
    -->
